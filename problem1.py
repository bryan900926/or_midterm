...
if m.status == GRB.OPTIMAL:
    ...
    #             if (
    #                 I[s, t, l].X > 0.5
    #             ):  # If there's inventory at this station/time/level
    #                 print(f"Time {t}: Station {s} has {I[s, t, l].X} cars of level {l}")
    # for f in F:
    #     if F[f].X > 0.5:  # If there's a relocation flow on this arc/time/level
    #         i, j, t, l = f
    #         print(
    #             f"Relocation from Station {i} to Station {j} at time {t} for car level {l}: "
    #             f"{F[f].X} cars moved"
    #         )
